...
export const units: CourseUnit[] = [
  {
    ...
    media: {
      zh: {
        ...
        checkedAt,
        selectionReason: "選用它是因為以臺灣社區實作說明口述歷史的定義與工作關係，能把抽象方法放進在地情境；觀看與互動表現不高，但主題貼合度與實務完整性較強。",
      },
      en: {
        videoId: "Xk3gb9xCTFo",
        ...
        checkedAt,
        selectionReason: "短片用多位實作者的語言界定口述歷史，適合建立第一個方法框架；高觀看數也顯示它長期被初學者使用，中文資源則補足臺灣脈絡。",
      },
    },
  },
  {
    ...
    media: {
      zh: {
        ...
        checkedAt,
        selectionReason: "動畫把訪前準備與訪談流程濃縮成可快速重看的一套步驟，觀看與互動表現在中文候選中較強；本課文字會補上選樣與專案治理。",
      },
      en: {
        videoId: "VBA7nzmTDX4",
  ...
  },
  {
    ...
    media: {
      ...
      en: {
        ...
        checkedAt,
        selectionReason: "以清楚示範說明訪談流程，觀看與互動表現在同主題候選中很強，適合拿來對照自己的問法與現場節奏。",
      },
    },
  },
  {
  ...
  },
  {
    ...
    media: {
      ...
      en: {
        ...
        checkedAt,
        selectionReason: "由大學口述史計畫完整示範轉錄流程，具有可跟做性與穩定的觀看與互動表現，適合用來比較並明文化自己的轉錄規範。",
      },
    },
  },
  {
    ...
    media: {
      zh: {
        ...
        checkedAt,
        selectionReason: "它示範可實作的 Whisper 轉錄流程，觀看與互動表現也較明顯；本課特別補上影片未必充分處理的同意、錯誤量測與保存原始輸出。",
      },
      en: {
        videoId: "Wzs7IoE8rps",
        ...
        checkedAt,
        selectionReason: "影片把 Whisper 初稿帶進質化研究工作流程，與本課的轉錄—分析銜接最直接；觀看後必須依本單元的稽核規則逐段回聽。",
      },
    },
  },
  {
    ...
    media: {
      ...
      en: {
        ...
        checkedAt,
        selectionReason: "Tate 展示檔案聲音如何轉成公共敘事，具清楚的策展案例與穩定的觀看與互動表現；它適合啟發形式，但不能取代本課的來源、同意與回看要求。",
      },
    },
  },
];
